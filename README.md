...
<h3>  ** Setting Up the Honeypot VM **: </h3>
...
<h3>  ** Collecting Failed RDP Logs **: </h3>
...
<h3> ** Running Azure Sentinel Queries **: </h3>
The collected data was then used to run Azure Sentinel queries, enabling us to identify patterns and potential threats. 

<h3>  ** Plotting Geographic Distribution **: </h3>
The output data was plotted on a map, providing a visual representation of the attempted attacks and their sources.
